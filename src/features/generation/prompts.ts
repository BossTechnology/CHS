...
═══════════════════════════════════════════════════════════════════════
Wherever this business is genuinely using AI — tools, agents, models, third-party AI services, automation — include them as natural line items within the relevant ADDIS and BLIPS sections. AI appears in Apps (ChatGPT Enterprise, Gemini, Copilot, chatbots), Dev (GitHub Copilot, Cursor, AI testing tools), Infrastructure (AI monitoring platforms like Datadog AI, anomaly detection), Systems (AI-enabled ERP modules), and across all BLIPS areas (demand forecasting initiatives, customer personalization programs, route optimization). Do NOT create a separate AI section. Do NOT force AI inclusion where it does not apply. Only surface AI where it is genuinely relevant to this specific business type. The deeper the tier, the more AI initiatives should be surfaced where applicable.
